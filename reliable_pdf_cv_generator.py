#!/usr/bin/env python3
"""
RELIABLE PDF CV GENERATOR
Creates professional CV files including REAL PDF - ONLY USES REPORTLAB (NO WINDOWS ISSUES)
"""
import os
import sys
import json
...
# Import PDF libraries at the top level - ONLY REPORTLAB
try:
...
def create_pdf_cv(cv_content, output_file):
    """Create PDF CV using ONLY reportlab - GUARANTEED TO WORK"""
...
def create_cv_files():
    ...
    print("RELIABLE PDF CV GENERATOR - ONLY REPORTLAB (NO WINDOWS ISSUES)")
    print("=" * 70)
    ...
    output_dir = Path(f"RELIABLE_CV_{timestamp}")
...
TO ADD NEW PROJECTS:
1. Edit the create_cv_content() function in reliable_pdf_cv_generator.py
